...
function INDEX_BOOT_HELPER(html) {
  ...
  const script = [
    ...
    '      // Session log pill takes 111px of the 390px header row and squeezes',
    '      // the session title to zero width; the same log view stays reachable',
    '      // through the 轨迹 tab right below, so hide the pill on the phone.',
