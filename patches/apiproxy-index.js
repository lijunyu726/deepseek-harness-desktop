...
const promptContentPartSchema = z$1.discriminatedUnion("type", [z$1.object({
	...
	fileKind: z$1.union([z$1.literal("file"), z$1.literal("folder")]).optional(),
	name: z$1.string(),
	size: z$1.number().int().nonnegative(),
	mediaType: z$1.string().optional(),
	path: z$1.string().optional(),
	shortPath: z$1.string().optional(),
	files: z$1.number().int().nonnegative().optional()
})]);
...
async function durablePromptContent(ctx, content) {
	if (content.every((part) => part.type === "text" || part.type === "file")) {
		return content.map((part) => part.type === "text" ? {
			...
			type: "file",
			...part.fileKind !== void 0 ? { fileKind: part.fileKind } : {},
			name: part.name,
			size: part.size,
			...part.mediaType !== void 0 ? { mediaType: part.mediaType } : {},
			...part.path !== void 0 ? { path: part.path } : {},
			...part.shortPath !== void 0 ? { shortPath: part.shortPath } : {},
			...part.files !== void 0 ? { files: part.files } : {}
		});
	}
	...
	const prepared = content.map((part) => part.type === "text" || part.type === "file" ? part : {
		part,
	...
	for (const item of prepared) {
		if (!("data" in item)) {
			if (item.type === "text") {
				...
				blocks.push({
					type: "file",
					...item.fileKind !== void 0 ? { fileKind: item.fileKind } : {},
					name: item.name,
					size: item.size,
					...item.mediaType !== void 0 ? { mediaType: item.mediaType } : {},
					...item.path !== void 0 ? { path: item.path } : {},
					...item.shortPath !== void 0 ? { shortPath: item.shortPath } : {},
