window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/virtual/deepseek-harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".S-h-AW_projectRow,.S-h-AW_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.S-h-AW_projectRow:hover,.S-h-AW_sessionRow:hover,.S-h-AW_sessionRow.S-h-AW_selected{background:var(--dsw-alias-interactive-bg-hover)}.S-h-AW_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.S-h-AW_searchResultRow:hover,.S-h-AW_searchResultRow.S-h-AW_selected{background:var(--dsw-alias-interactive-bg-hover)}.S-h-AW_searchResultHeading{align-items:center;min-width:0;display:flex}.S-h-AW_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.S-h-AW_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.S-h-AW_searchResultWorkspace,.S-h-AW_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.S-h-AW_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.S-h-AW_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.S-h-AW_projectRow{box-sizing:border-box;align-items:center;height:34px}.S-h-AW_projectRow .S-h-AW_rowActions{height:20px}.S-h-AW_sessionRow{height:32px;animation:S-h-AW_row-in .15s var(--ds-ease-in-out);gap:0}.S-h-AW_sessionRow .S-h-AW_title{margin:0 6px 0 4px}.S-h-AW_flatSessionRowWithoutStatus .S-h-AW_title{margin-left:0}@keyframes S-h-AW_row-in{0%{opacity:0}}.S-h-AW_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.S-h-AW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.S-h-AW_folderActive{color:var(--dsw-alias-state-business-primary)}.S-h-AW_projectRow .S-h-AW_chevron{display:none}.S-h-AW_projectRow:hover .S-h-AW_chevron{display:inline-flex}.S-h-AW_projectRow:hover .S-h-AW_folder{display:none}.S-h-AW_arrow{transition:transform .15s var(--ds-ease-in-out)}.S-h-AW_arrowOpen{transform:rotate(90deg)}.S-h-AW_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.S-h-AW_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.S-h-AW_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.S-h-AW_sessionRow .S-h-AW_title{flex:1}.S-h-AW_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.S-h-AW_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.S-h-AW_dot{flex:none}.S-h-AW_rowActions{flex:none;align-items:center;gap:12px;display:none}.S-h-AW_projectRow:hover .S-h-AW_rowActions,.S-h-AW_sessionRow:hover .S-h-AW_rowActions,.S-h-AW_projectRow.S-h-AW_menuOpen .S-h-AW_rowActions,.S-h-AW_sessionRow.S-h-AW_menuOpen .S-h-AW_rowActions{display:inline-flex}.S-h-AW_sessionRow:hover .S-h-AW_time,.S-h-AW_sessionRow.S-h-AW_menuOpen .S-h-AW_time{display:none}.S-h-AW_projectRow.S-h-AW_menuOpen,.S-h-AW_sessionRow.S-h-AW_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.S-h-AW_sessionRow.S-h-AW_dropBefore,.S-h-AW_sessionRow.S-h-AW_dropAfter{position:relative}.S-h-AW_sessionRow.S-h-AW_dropBefore:before,.S-h-AW_sessionRow.S-h-AW_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.S-h-AW_sessionRow.S-h-AW_dropBefore:before{top:-7px}.S-h-AW_sessionRow.S-h-AW_dropAfter:after{bottom:-7px}.S-h-AW_hoverContent{flex-direction:column;gap:8px;display:flex}.S-h-AW_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.S-h-AW_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.S-h-AW_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.S-h-AW_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.S-h-AW_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.S-h-AW_iconButton:hover{color:var(--dsw-alias-label-primary)}.S-h-AW_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.S-h-AW_sessionRow,.S-h-AW_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"hoverContent": "S-h-AW_hoverContent",
			"chevron": "S-h-AW_chevron",
			"selected": "S-h-AW_selected",
			"searchResultRow": "S-h-AW_searchResultRow",
			"hoverTime": "S-h-AW_hoverTime",
			"time": "S-h-AW_time",
			"hoverStatus": "S-h-AW_hoverStatus",
			"dot": "S-h-AW_dot",
			"projectText": "S-h-AW_projectText",
			"arrow": "S-h-AW_arrow",
			"hoverTitle": "S-h-AW_hoverTitle",
			"searchResultWorkspace": "S-h-AW_searchResultWorkspace",
			"meta": "S-h-AW_meta",
			"menuOpen": "S-h-AW_menuOpen",
			"dropAfter": "S-h-AW_dropAfter",
			"rowActions": "S-h-AW_rowActions",
			"folderActive": "S-h-AW_folderActive",
			"hoverPath": "S-h-AW_hoverPath",
			"slot": "S-h-AW_slot",
			"dropBefore": "S-h-AW_dropBefore",
			"folder": "S-h-AW_folder",
			"projectRow": "S-h-AW_projectRow",
			"searchResultTitle": "S-h-AW_searchResultTitle",
			"iconButton": "S-h-AW_iconButton",
			"visuallyHidden": "S-h-AW_visuallyHidden",
			"searchResultMeta": "S-h-AW_searchResultMeta",
			"flatSessionRowWithoutStatus": "S-h-AW_flatSessionRowWithoutStatus",
			"title": "S-h-AW_title",
			"sessionRow": "S-h-AW_sessionRow",
			"searchResultHeading": "S-h-AW_searchResultHeading",
			"searchResultSnippet": "S-h-AW_searchResultSnippet",
			"row-in": "S-h-AW_row-in",
			"arrowOpen": "S-h-AW_arrowOpen",
			"renameInput": "S-h-AW_renameInput"
		};
		//#endregion
		...
		* @param props.onDelete - delete a session by id (confirmation dialog in the browser root).
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/virtual/deepseek-harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".i2BSTW_modalAction{min-width:72px}.i2BSTW_modalError,.i2BSTW_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.i2BSTW_modalError{color:var(--dsw-alias-state-error-primary)}.i2BSTW_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "i2BSTW_menuStatus",
			"modalAction": "i2BSTW_modalAction",
			"modalError": "i2BSTW_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/virtual/deepseek-harness/packages/client/ui-workspace/src/client/WorkspaceBrowser.module.css.mjs
		const css = ".ndjalW_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.ndjalW_root.ndjalW_rail{padding-right:0}.ndjalW_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.ndjalW_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.ndjalW_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.ndjalW_root:not(.ndjalW_rail) .ndjalW_sectionHeader{margin-top:2px;margin-right:-4px}.ndjalW_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.ndjalW_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.ndjalW_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.ndjalW_searchSlotExpanded{max-width:100%;padding-left:0}.ndjalW_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.ndjalW_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.ndjalW_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.ndjalW_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.ndjalW_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.ndjalW_searchExpanded .ndjalW_searchButton{width:28px;height:30px}.ndjalW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.ndjalW_searchExpanded .ndjalW_searchButton:hover{background:0 0}.ndjalW_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.ndjalW_searchExpanded .ndjalW_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.ndjalW_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.ndjalW_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.ndjalW_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.ndjalW_rail .ndjalW_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.ndjalW_rail .ndjalW_headerActions{max-width:none}.ndjalW_rail .ndjalW_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.ndjalW_rail .ndjalW_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.ndjalW_rail .ndjalW_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.ndjalW_rail .ndjalW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.ndjalW_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.ndjalW_rail .ndjalW_listArea{margin-left:0;margin-right:0;padding-left:0}.ndjalW_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.ndjalW_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.ndjalW_wide{animation:ndjalW_wide-in .2s var(--ds-ease-in-out)}@keyframes ndjalW_wide-in{0%{opacity:0}}.ndjalW_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.ndjalW_flatList>*+*,.ndjalW_searchTree>[role=treeitem]+[role=treeitem],.ndjalW_groupSection>*+*{margin-top:2px}.ndjalW_searchStatus,.ndjalW_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.ndjalW_searchWarning{color:var(--dsw-alias-label-secondary)}.ndjalW_groupSection{position:relative}.ndjalW_groupSection+.ndjalW_groupSection{margin-top:4px}.ndjalW_listTopDropIndicator,.ndjalW_workspaceDropBefore:before,.ndjalW_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.ndjalW_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.ndjalW_listTopDropActive>.ndjalW_workspaceDropBefore:first-child:before{display:none}.ndjalW_workspaceDropBefore:before{top:-8px}.ndjalW_workspaceDropAfter:after{bottom:-8px}.ndjalW_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.ndjalW_groupSection>.ndjalW_sessionOverflowButton{margin-top:0}.ndjalW_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.ndjalW_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.ndjalW_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.ndjalW_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.ndjalW_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.ndjalW_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.ndjalW_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.ndjalW_wide{animation:none}.ndjalW_search,.ndjalW_sectionLabel,.ndjalW_searchSlot,.ndjalW_searchInput,.ndjalW_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "ndjalW_clearButton",
			"searchSlotExpanded": "ndjalW_searchSlotExpanded",
			"searchButton": "ndjalW_searchButton",
			"searchTree": "ndjalW_searchTree",
			"listTopDropActive": "ndjalW_listTopDropActive",
			"deleteAction": "ndjalW_deleteAction",
			"empty": "ndjalW_empty",
			"searchInput": "ndjalW_searchInput",
			"workspaceDropAfter": "ndjalW_workspaceDropAfter",
			"searchStatus": "ndjalW_searchStatus",
			"sectionLabelHidden": "ndjalW_sectionLabelHidden",
			"wide-in": "ndjalW_wide-in",
			"root": "ndjalW_root",
			"listTopDropIndicator": "ndjalW_listTopDropIndicator",
			"deleteStatus": "ndjalW_deleteStatus",
			"headerActions": "ndjalW_headerActions",
			"sectionLabel": "ndjalW_sectionLabel",
			"headerActionsHidden": "ndjalW_headerActionsHidden",
			"search": "ndjalW_search",
			"workspaceDropBefore": "ndjalW_workspaceDropBefore",
			"sectionHeader": "ndjalW_sectionHeader",
			"searchExpanded": "ndjalW_searchExpanded",
			"renameInput": "ndjalW_renameInput",
			"flatList": "ndjalW_flatList",
			"searchSlot": "ndjalW_searchSlot",
			"groupSection": "ndjalW_groupSection",
			"iconButton": "ndjalW_iconButton",
			"listArea": "ndjalW_listArea",
			"rail": "ndjalW_rail",
			"fade": "ndjalW_fade",
			"list": "ndjalW_list",
			"treeBody": "ndjalW_treeBody",
			"searchWarning": "ndjalW_searchWarning",
			"renameError": "ndjalW_renameError",
			"sessionOverflowButton": "ndjalW_sessionOverflowButton",
			"wide": "ndjalW_wide"
		};
		//#endregion
		...
		*/
		function WorkspaceBrowser({ wide, expandSidebar, useSessions, useWorkspaces, useStore, actions, startSession, open, renameSession, forkSession, renameWorkspace, deleteWorkspace, insertWorkspaceBefore, archiveSession, deleteSession, insertSessionBefore, createWorkspace, searchSessions, searchResultLimit, useDirectoryFlow, renderSlot, t }) {
			...
			// Close the dialog as soon as the target session leaves the list —
			// regardless of how the delete RPC settles. A session deleted while
			// still attached in the host converges through a stream update, and
			// a lost RPC response must never freeze the dialog on "deleting…"
			// with every button dead.
			(0, react.useEffect)(() => {
				if (sessionDeleteTarget === null) return;
				if (sessionList.ids.includes(sessionDeleteTarget.sessionId)) return;
				setSessionDeleting(false);
				setSessionDeleteCommittedId(null);
				setSessionDeleteTarget(null);
				setSessionDeleteError(null);
			}, [sessionDeleteTarget, sessionList]);
			// Backstop: if neither the RPC settles usefully nor the list drops
			// the session within 15s, release the dialog so the user can close
			// or retry instead of being trapped.
			(0, react.useEffect)(() => {
			...
			const closeSessionDelete = () => {
				// Closing never blocks: the host delete continues in the
				// background and the list stream reflects its completion.
				setSessionDeleteTarget(null);
				setSessionDeleteError(null);
			};
		...
		*/
		...
		const zh = {
			...
			"delete.desc": "将把“{name}”从工作区列表中移除，并永久删除其中的全部会话与聊天记录。此操作不可恢复，文件夹本身会保留。",
			"delete.pending": "正在删除工作区…",
			"menu.fork": "分叉会话",
			"menu.archiveSession": "归档会话",
			"menu.deleteSession": "删除会话",
			"delete.session": "删除会话",
			"delete.session.desc": "将永久删除会话“{name}”及其全部对话记录，此操作不可撤销。",
		...
		const en = {
			...
			"delete.desc": "This removes “{name}” from the workspace list and permanently deletes all of its sessions and chat logs. This cannot be undone; the folder itself is kept.",
			"delete.pending": "Deleting workspace…",
			"menu.fork": "Fork session",
			"menu.archiveSession": "Archive session",
			"menu.deleteSession": "Delete session",
			"delete.session": "Delete session",
			"delete.session.desc": "This permanently deletes session “{name}” and all of its conversation history. This cannot be undone.",
		...
		function apply(ctx) {
			...
			const browserInjected = () => ({
				...
				deleteWorkspace: async (workspaceId) => {
					...
					// The Host permanently deletes the workspace's sessions along
					// with it; refresh the session baseline so the cold ones (no
					// live `session/disposed` frame) leave the list immediately.
